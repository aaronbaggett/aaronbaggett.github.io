...
Based on the recommendation of our firm's research analyst, Lisa Baggett, M.D., Pat and Aaron decide to invest $10,000 in Tesla ([TSLA](https://finance.yahoo.com/quote/TSLA?p=TSLA)) on July 25, 2017 at a market closing price of $`r round(tsla_summ$Close[1], 2)`
...
Including a $7.001 cost of trade, as of `r format(Sys.Date()-1, "%A, %B %d, %Y")`, we are **`r updown`** $`r daily`.
