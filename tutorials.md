...
Slides used in video tutorials are available by clicking the <span class="glyphicon glyphicon-file"></span> icon. **R** code used in tutorials are available by clicking the <span class="glyphicon glyphicon-signal"></span> icon.
